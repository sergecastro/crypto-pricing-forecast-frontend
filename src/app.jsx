...
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip } from 'recharts'; // New import for chart
...
const api = {
  ...
  history: (symbol) =>
    fetch(`${API_BASE}/history/${symbol}`).then((r) => r.json()).catch(() => null), // New history endpoint
};
...
export default function App() {
  ...
  const [history, setHistory] = useState([]); // New state for price history
  ...
  // Fetch price history when symbol changes
  useEffect(() => {
